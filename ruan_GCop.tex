...
\section{Ordinal pattern transition networks} \label{sec:intro}
...
\bibitem{Bradley2015c}
E.~Bradley and H.~Kantz.
\newblock {Nonlinear time-series analysis revisited}.
\newblock {\em Chaos}, 25(9):097610, 2015.
...
\newblock Complex network approaches to nonlinear time series analysis.
\newblock {\em Physics Reports}, doi: 10.1016/j.physrep.2018.10.005, in press.

\bibitem{Marwan2009}
N.~Marwan, J.~F. Donges, Y.~Zou, R.~V. Donner, and J.~Kurths.
\newblock {Complex network approach for recurrence analysis of time series}.
\newblock {\em Phys. Lett. A}, 373(46):4246--4254, 2009.

\bibitem{Donner2010NJP}
R.~V. Donner, Y.~Zou, J.~F. Donges, N.~Marwan, and J.~Kurths.
\newblock Recurrence networks -- {A} novel paradigm for nonlinear time series
  analysis.
\newblock {\em New J. Phys.}, 12(3):033025, 2010.

\bibitem{Lacasa2008}
L.~Lacasa, B.~Luque, F.~Ballesteros, J.~Luque, and J.~C. Nuno.
\newblock {From time series to complex networks: The visibility graph}.
\newblock {\em Proc. Natl. Acad. Sci.}, 105(13):4972--4975, 2008.

\bibitem{Nicolis2005}
G.~Nicolis, A.~G. Cantu, and C.~Nicolis.
\newblock {Dynamical aspects of interaction networks}.
\newblock {\em Int. J. Bifurc. Chaos}, 15(11):3467--3480, 2005.

\bibitem{McCullough2015}
M.~McCullough, M.~Small, T.~Stemler, and Herbert H.-H. Iu.
\newblock {Time lagged ordinal partition networks for capturing dynamics of
  continuous dynamical systems}.
\newblock {\em Chaos}, 25(5):053101, 2015.

\bibitem{Zhang2006}
J.~Zhang and M.~Small.
\newblock {Complex Network from Pseudoperiodic Time Series: Topology versus
  Dynamics}.
\newblock {\em Phys. Rev. Lett.}, 96(23):238701, 2006.

\bibitem{Donges2011PNAS}
J.~F. Donges, R.~V. Donner, M.~H. Trauth, N.~Marwan, H.~J. Schellnhuber, and
  J.~Kurths.
\newblock Nonlinear detection of paleoclimate-variability transitions possibly
  related to human evolution.
\newblock {\em Proc. Natl. Acad. Sci. USA}, 108:20422--20427, 2011.

\bibitem{Elsner2009}
J.~B. Elsner, T.~H. Jagger, and E.~a. Fogarty.
\newblock {Visibility network of United States hurricanes}.
\newblock {\em Geophys. Res. Lett.}, 36(16):L16702, 2009.

\bibitem{schleussner2015indications}
C.-F. Schleussner, D~V Divine, J~F Donges, A~Miettinen, and R~V Donner.
\newblock {Indications for a North Atlantic ocean circulation regime shift at
  the onset of the Little Ice Age}.
\newblock {\em Clim. Dyn.}, 45(11-12):3623--3633, 2015.

\bibitem{Liu2009}
C.~Liu, W.-X. Zhou, and W.-K. Yuan.
\newblock Statistical properties of visibility graph of energy dissipation
  rates in three-dimensional fully developed turbulence.
\newblock {\em Physica A}, 389(13):2675--2681, 2010.

\bibitem{Gorski2015}
G.~G{\'{o}}rski, G.~Litak, R.~Mosdorf, and A.~Rysak.
\newblock {Two phase flow bifurcation due to turbulence: transition from slugs
  to bubbles}.
\newblock {\em Eur. Phys. J. B}, 88(9):239, 2015.

\bibitem{Gao2015a}
Z.-K. Gao, Y.-X. Yang, P.-C. Fang, Y.~Zou, C.-Y. Xia, and M.~Du.
\newblock {Multiscale complex network for analyzing experimental multivariate
  time series}.
\newblock {\em EPL (Europhysics Lett.}, 109(3):30005, 2015.

\bibitem{Gao2016b}
Z.-K. Gao, Y.-X. Yang, Q.~Cai, S.-S. Zhang, and N.-D. Jin.
\newblock {Multivariate weighted recurrence network inference for uncovering
  oil-water transitional flow behavior in a vertical pipe}.
\newblock {\em Chaos}, 26(6):063117, 2016.

\bibitem{Manshour2015a}
P.~Manshour, M.~R. {Rahimi Tabar}, and J.~Peinke.
\newblock {Fully developed turbulence in the view of horizontal visibility
  graphs}.
\newblock {\em J. Stat. Mech. Theory Exp.}, 2015(8):P08031, 2015.

\bibitem{Ramirez2013}
G.~M. {Ram{\'{i}}rez {\'{A}}vila}, A.~Gapelyuk, N.~Marwan, H.~Stepan,
  J{\"{u}}rgen Kurths, T.~Walther, and N.~Wessel.
\newblock {Classifying healthy women and preeclamptic patients from
  cardiovascular data using recurrence and complex network methods}.
\newblock {\em Auton. Neurosci. Basic Clin.}, 178(1-2):103--110, 2013.

\bibitem{Subramaniyam2015}
N.~P. Subramaniyam, J.~F. Donges, and J.~Hyttinen.
\newblock {Signatures of chaotic and stochastic dynamics uncovered with
  $\epsilon$ -recurrence networks}.
\newblock {\em Proc. R. Soc. A Math. Phys. Eng. Sci.}, 471(2183):20150349,
  2015.

\bibitem{Flanagan2016}
R.~Flanagan and L.~Lacasa.
\newblock {Irreversibility of financial time series: A graph-theoretical
  approach}.
\newblock {\em Phys. Lett. A}, 380(20):1689--1697, 2016.

\bibitem{Zou2014a}
Y.~Zou, M.~Small, Z.~H. Liu, and J.~Kurths.
\newblock {Complex network approach to characterize the statistical features of
  the sunspot series}.
\newblock {\em New J. Phys.}, 16(1):013051, 2014.

\bibitem{Zou2014}
Y.~Zou, R.~V. Donner, N.~Marwan, M.~Small, and J.~Kurths.
\newblock {Long-term changes in the north–south asymmetry of solar activity:
  a nonlinear dynamics characterization using visibility graphs}.
\newblock {\em Nonlinear Process. Geophys.}, 21(6):1113--1126, 2014.

\bibitem{Schnakenberg1976}
J.~Schnakenberg.
\newblock {Network theory of microscopic and macroscopic behavior of master
  equation systems}.
\newblock {\em Rev. Mod. Phys.}, 48(4):571--585, 1976.

\bibitem{KulpChaos2016}
C.~W. Kulp, J.~M. Chobot, H.~R. Freitas, and G.~D. Sprechini.
\newblock Using ordinal partition transition networks to analyze ecg data.
\newblock {\em Chaos}, 26(7):073114, 2016.

\bibitem{KulpChaos2016b}
C.~W. Kulp, J.~M. Chobot, B.~J. Niskala, and C.~J. Needhammer.
\newblock Using forbidden ordinal patterns to detect determinism in irregularly
  sampled time series.
\newblock {\em Chaos}, 26(2):023107, 2016.

\bibitem{McCulloughChaos2016}
M.~McCullough, K.~Sakellariou, T.~Stemler, and M.~Small.
\newblock {Counting forbidden patterns in irregularly sampled time series. I.}
  the effects of under-sampling, random depletion, and timing jitter.
\newblock {\em Chaos}, 26(12):123103, 2016.

\bibitem{SakellariouChaos2016}
K.~Sakellariou, M.~McCullough, T.~Stemler, and M.~Small.
\newblock {Counting forbidden patterns in irregularly sampled time series. II.
  Reliability in the presence of highly irregular sampling}.
\newblock {\em Chaos}, 26(12):123104, 2016.

\bibitem{Bandt2002}
C.~Bandt and B.~Pompe.
\newblock {Permutation Entropy: A Natural Complexity Measure for Time Series}.
\newblock {\em Phys. Rev. Lett.}, 88(17):174102, 2002.

\bibitem{Daw2003}
C.~S. Daw, C.~E.~A. Finney, and E.~R. Tracy.
\newblock {A review of symbolic analysis of experimental data}.
\newblock {\em Rev. Sci. Instrum.}, 74(2):915--930, 2003.

\bibitem{Finn2003}
J.~M. Finn, J.~D. Goettee, Z.~Toroczkai, M.~Anghel, and B.~P. Wood.
\newblock {Estimation of entropies and dimensions by nonlinear symbolic time
  series analysis}.
\newblock {\em Chaos}, 13(2):444--456, 2003.

\bibitem{Amigo2010}
J.~Amig{\'{o}}.
\newblock {\em {Permutation Complexity in Dynamical Systems}}.
\newblock Spinger, Berlin/Heidelberg, 2010.

\bibitem{McCullough2017b}
M.~McCullough, M.~Small, H.~H.~C. Iu, and T.~Stemler.
\newblock {Multiscale ordinal network analysis of human cardiac dynamics}.
\newblock {\em Philos. Trans. R. Soc. A Math. Phys. Eng. Sci.},
  375(2096):20160292, 2017.

\bibitem{zhangSciRep2017}
J.~Y. Zhang, J.~Zhou, M.~Tang, H.~Guo, M.~Small, and Y.~Zou.
\newblock Constructing ordinal partition transition networks from multivariate
  time series.
\newblock {\em Scientific Reports}, 7:7795, 2017.

\bibitem{Guo2018}
H.~Guo, J.-Y. Zhang, Y.~Zou, and S.-G. Guan.
\newblock {Cross and joint ordinal partition transition networks for
  multivariate time series analysis}.
\newblock {\em Front. Phys.}, 13(5):130508, 2018.

\bibitem{Coufal2017}
D.~Coufal, J.~Jakubík, N.~Jajcay, J.~Hlinka, A.~Krakovsk\'a, and M.~Palu\v{s}.
\newblock Detection of coupling delay: A problem not yet solved.
\newblock {\em Chaos}, 27(8):083109, 2017.

\bibitem{Granger1969}
C.~W.~J. Granger.
\newblock Investigating causal relations by econometric models and
  cross-spectral methods.
\newblock {\em Econometrica}, 37(3):424--438, 1969.

\bibitem{Ding_Book_2007}
M.~Z. Ding, Y.~H. Chen, and S.~L Bressler.
\newblock {Granger Causality: Basic Theory and Application to Neuroscience}.
\newblock In Bj{\"{o}}rn Schelter, Matthias Winterhalder, and Jens Timmer,
  editors, {\em Handb. Time Ser. Anal.}, pages 437--460. Wiley-VCH Verlag GmbH
  {\&} Co. KGaA, 2007.

\bibitem{Dhamala_prl2008}
M.~Dhamala, G.~Rangarajan, and M.~Z. Ding.
\newblock {Estimating Granger Causality from Fourier and Wavelet Transforms of
  Time Series Data}.
\newblock {\em Phys. Rev. Lett.}, 100(1):018701, 2008.

\bibitem{Takens1981}
F.~Takens.
\newblock {Detecting strange attractors in turbulence}.
\newblock In D.A. Rand and L.-S. Young, editors, {\em Dynamical Systems and
  Turbulence, Warwick 1980}, volume 898 of {\em Lecture Notes in Mathematics},
  pages 366--381. Springer, New York, 1981.

\bibitem{LiPRE2018}
S.~T. Li, Y.~Y. Xiao, D.~Zhou, and D.~Cai.
\newblock Causal inference in nonlinear systems: Granger causality versus
  time-delayed mutual information.
\newblock {\em Phys. Rev. E}, 97:052216, 2018.

\bibitem{RomanoPRE2007}
M.~C. Romano, M.~Thiel, J.~Kurths, and C.~Grebogi.
\newblock Estimation of the direction of the coupling by conditional
  probabilities of recurrence.
\newblock {\em Phys. Rev. E}, 76:036211, 2007.

\bibitem{Rybski2003}
D.~Rybski, S.~Havlin, and A.~Bunde.
\newblock Phase synchronization in temperature and precipitation records.
\newblock {\em Physica A}, 320:601 -- 610, 2003.
